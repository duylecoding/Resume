...
\begin{indentsection}{\parindent}
	...
	\begin{itemize*}
		\item Discover ways to measure, track, develop, and improve the Drive Search experience
		\item Took intitiative to improve the legacy indexing system from ideation, design, and implementation
		\item Developed and rolled out UI features in Drive to help users find their files quicker
		\item Assisted in backend and infrastructure work to move priorities forward
	\end{itemize*}
\end{indentsection}
\begin{indentsection}{\parindent}
	\vspace{-0.4em}
