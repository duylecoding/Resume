...
\begin{indentsection}{\parindent}
	...
	\begin{itemize*}
		\item Delivered features that boosted user engagement such as folder summaries and AI Overviews
		\item Used expertise in Drive's full Search stack to deliver AI enhancements to Search results
                   \item Consistently challenged and improved data quality by auditing impression logging and diving through user feedback
	\end{itemize*}
	\headerrow
...
\begin{indentsection}{\parindent}
	...
	\begin{itemize*}
		...
		\item Discovered and resolved a major security vulnerability (auth bypass) in existing applications
	\end{itemize*}
\end{indentsection}
\begin{indentsection}{\parindent}
	\vspace{-0.4em}
